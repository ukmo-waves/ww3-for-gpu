...
!$ACC         CREATE(SSTXFTF, SSTXFTWN, SSTXFTFTAIL, ZZ0RAT           )&
!$ACC         CREATE(AALPHA, ZZWND, BBETA, ZZALP, TTAUWSHELTER        )&
!$ACC         CREATE(SSINTHP, SSINBR, XFR,FACHFE,KDCON, KDMN, SNLC1   )&
!$ACC         CREATE(SNLS1, SNLS2, SNLS3, EC2, ES2, ESC, SSDSP, DSIP  )&
!$ACC         CREATE(SSDSISO, SSDSDTH, SSDSBR2, SSDSBRFDF, SSDSBCK    )&
!$ACC         CREATE(NKHS, NKD, NDTAB, SSDSBR, SLNC1, FSPM, FSHF)
...
!
      ...
      ALLOCATE ( MPARS(IMOD)%SRCPS%IKTAB(MK,NDTAB), &
                 ...
                 STAT=ISTAT                         )
      CHECK_ALLOC_STATUS ( ISTAT )
!$ACC UPDATE DEVICE(NKHS, NKD, NDTAB)
