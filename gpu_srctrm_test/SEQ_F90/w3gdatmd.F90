...
!/
!
!GPUNotes Key differences to use COPYIN rather than create, as the
!variables have not yet been set. We prefer the option to copy in blank
!values and overwrite once they are available. 
!
