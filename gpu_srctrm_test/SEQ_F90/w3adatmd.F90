...
!$ACC DECLARE CREATE(NFR, NFRHGH, NFRCHG, NSPECX, NSPECY)       & 
!$ACC         CREATE(IP11, IP12, IP13, IP14, IM11, IM12, IM13, IM14)   &
!$ACC         CREATE(IP21, IP22, IP23, IP24, IM21, IM22, IM23, IM24)   &
!$ACC         CREATE(IC11, IC12, IC21, IC22, IC31, IC32, IC41, IC42)   &
!$ACC         CREATE(IC51, IC52, IC61, IC62, IC71, IC72, IC81, IC82)   &
!$ACC         CREATE(DAL1, DAL2, DAL3, AF11)                           &
!$ACC         CREATE(AWG1, AWG2, AWG3, AWG4, AWG5, AWG6, AWG7, AWG8)   &
!$ACC         CREATE(SWG1, SWG2, SWG3, SWG4, SWG5, SWG6, SWG7, SWG8)
!/
      CONTAINS
!/ ------------------------------------------------------------------- /
