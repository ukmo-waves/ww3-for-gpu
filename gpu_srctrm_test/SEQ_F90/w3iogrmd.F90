...
!$ACC                EC2,FACHFA,FACHFE,FACTI1,FACTI2,FTF,FTE,ESC,DSIP)
        END IF
...
!$ACC            COPYIN(ZZWND, AALPHA, TTAUWSHELTER,DELUST,DELALP) &
!$ACC            COPYIN(SSDSBM,SSTXFTF,  SSTXFTFTAIL, SSTXFTWN,DELTAIL) &
!$ACC            COPYIN(WWNMEANP, WWNMEANPTAIL, FFXFM, FFXPM, SSDSBINT)    &
!$ACC            COPYIN(FFXFA,SSINBR,DELU,SSDSBR2,DELTAUW,SSDSBCK )
