...
!$ACC            COPYIN(EC2,FACHFA,FACHFE,FACTI1,FACTI2,FTF,FTE,ESC)
!$ACC UPDATE DEVICE (DDEN,DDEN2,ES2,ESIN,ECOS,DTH,SIG,SIG2,XFR, &
      ...
      IF ( WRITE ) THEN
        ...
        ELSE
          ...
          READ (NDSM,END=801,ERR=802,IOSTAT=IERR)                     &
                FACP, XREL, XFLT, FXFM, FXPM, XFT, XFC, FACSD, FHMAX, &
                FFACBERG, DELAB, FWTABLE
!$ACC ENTER DATA COPYIN(XREL,XFLT,XFC, XFT,FACP, FWTABLE,DELAB)
...
!$ACC            CREATE(SSDSBM,SSTXFTF,  SSTXFTFTAIL, SSTXFTWN,DELTAIL) &
